    ...
    $results = $woocommerce->get('orders');
     /*foreach ($results as $result) {
        ...
        if($s=="completed"){
            ...
            $itemsname=$result->line_items->id;
           ...
           $stmt = $conn->prepare("INSERT INTO datos(billing_first_name,billing_last_name,	billing_email,	line_items_name,billing_address1,billing_address2) VALUES (?,?,?,?,?,?)");
            echo "hola";
            $stmt->bind_param('ssssss', $firstname, $lastname,$email,$itemsname,$address1,$address2);
            $stmt->execute();
